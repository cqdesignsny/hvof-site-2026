...
// contract). Last synced 2026-06-10 against Signal's 11-block snapshot.
//
// Signal owns the connectors. Floorplan only reads. Every block always arrives
...
// --- Native leads (Floorplan's own form pipeline, surfaced back through Signal) ---
...
// --- The snapshot: 11 blocks, every one always present with a status. ---
