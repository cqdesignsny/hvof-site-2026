      ...
      <div className="container-editorial flex h-16 items-center justify-between md:h-20">
          ...
          {NAV.primary.map((item) =>
            item.label === "Furniture" ? (
              ...
              <Link
                key={item.href}
                href={item.href}
                className="rounded-full px-4 py-2 text-sm text-foreground/80 transition-colors hover:bg-foreground/5 hover:text-foreground"
              >
                {item.label}
              </Link>
            ),
        ...
        <div className="flex items-center gap-2">
          <Link
            ...
            className="hidden items-center gap-1.5 rounded-full px-3 py-2 text-sm font-medium text-foreground/80 hover:text-foreground lg:inline-flex"
          ...
          <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent side="right" className="w-full max-w-md border-l-0 p-0 sm:max-w-md">
              <div className="flex h-full flex-col bg-background">
                ...
                <div className="border-t bg-foreground p-4">
  ...
  return (
    <div className="relative" onMouseEnter={() => setOpen(true)} onMouseLeave={() => setOpen(false)}>
      <button
        type="button"
        className={cn(
          "rounded-full px-4 py-2 text-sm text-foreground/80 transition-colors hover:bg-foreground/5 hover:text-foreground",
      ...
      {open ? (
        <div className="absolute left-1/2 top-full -translate-x-1/2 pt-3">
          <div className="grid w-[640px] grid-cols-3 gap-1 rounded-2xl border border-border bg-background p-3 shadow-2xl shadow-black/5">
